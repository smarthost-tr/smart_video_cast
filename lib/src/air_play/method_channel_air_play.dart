...
import 'package:smart_video_cast/src/air_play/air_play_event.dart';
import 'package:smart_video_cast/src/air_play/air_play_platform.dart';
...
class MethodChannelAirPlay extends AirPlayPlatform {
  ...
  Future<void> init(int id) {
    ...
    if (!_channels.containsKey(id)) {
      channel = MethodChannel('smart_video_cast/airPlay_$id');
